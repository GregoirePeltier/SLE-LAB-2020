 ...
 * </p>
 * <ul>
 *   <li>{@link unice.epu.carpilot.ecore.carpilot.impl.CommandImpl#getDirection <em>Direction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommandImpl extends MinimalEObjectImpl.Container implements Command {
	...
	protected EClass eStaticClass() {
		return CarpilotPackage.Literals.COMMAND;
	}
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarpilotPackage.COMMAND__DIRECTION, oldDirection,
					direction));
	}
